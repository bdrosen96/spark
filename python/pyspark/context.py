...
class SparkContext:
    ...
    def range(
        self, start     , end                = None, step      = 1, numSlices                = None
    )            :
        """
    ...
    def textFile(
        self, name     , minPartitions                = None, use_unicode       = True
    )            :
        """
    ...
    def wholeTextFiles(
        self, path     , minPartitions                = None, use_unicode       = True
    )                        :
        """
