...
def _invoke_function_over_columns(name     , *cols                )          :
    """
...
def _invoke_function_over_seq_of_columns(name     , cols                          )          :
    """
...
@overload
def unix_timestamp(timestamp                , format      = ...)          :
    ...
...
def array_join(
    col                , delimiter     , null_replacement                = None
)          :
    """
