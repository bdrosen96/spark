...
def is_name_like_value(
    value     , allow_none       = True, allow_tuple       = True, check_type       = False
)        :
    """
...
def spark_column_equals(left        , right        )        :
    """
