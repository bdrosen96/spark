...
class Series(Frame, IndexOpsMixin, Generic[T]):
    ...
    def rename_axis(
        self, mapper                = None, index                = None, inplace       = False
    )                      :
        """
    ...
    def sort_values(
        self, ascending       = True, inplace       = False, na_position      = "last"
    )                      :
        """
        Sort by the values.
    ...
    def compare(
        self, other          , keep_shape       = False, keep_equal       = False
    )             :
        """
